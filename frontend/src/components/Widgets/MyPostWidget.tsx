...
import WidgetWrapper from "@/components/Style/WidgetWrapper";
...
export default function UserWidget({ picturePath }: MyPostWidgetProps) {
  ...
  const handlePost = async () => {
    if (_id && typeof _id === "string") {
      ...
      // Handle the case when user is null or _id is not a valid string
